...
impl Computer {
    ...
    fn evaluate(&mut self, program: &[u64]) -> Vec<u64> {
        ...
        loop {
            ...
            match instruction {
                Instruction::Adv => self.a /= 2u64.pow(self.combo(operand) as u32),
                ...
                Instruction::Bdv => self.b = self.a / 2u64.pow(self.combo(operand) as u32),
                Instruction::Cdv => self.c = self.a / 2u64.pow(self.combo(operand) as u32),
            }
            pointer += 2;
        }
        out
